...
| Enterprise-Multi-Site-Network | Three-site branch network over a dual-ISP WAN, with GRE tunneling and dynamic routing between sites | GRE Tunneling, OSPF, HSRP, VLANs, DHCP Relay, NAT/PAT, ACL, EtherChannel, STP, SSH, TFTP, SYSLOG, DNS, ROUTER-ON-STICK | Completed |
