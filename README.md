...
| [Enterprise Multi-Site-Network](./Enterprise Multi-Site-Network) | Branch network design | VPN, WAN, Routing, VLANs, HSRP, OSPF, DHCP, File Server, NAT, ACL, STP, SSH, SNMP, Syslog, DNS | Planned |
